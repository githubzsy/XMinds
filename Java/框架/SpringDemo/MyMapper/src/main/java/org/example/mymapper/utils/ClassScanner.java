package org.example.mymapper.utils;
...
public class ClassScanner {
    ...
    public Integer scanning(String packagePath, boolean recursive) {
        ...
        try {
            ...
            packPrefix = URLDecoder.decode(Thread.currentThread().getContextClassLoader().getResource("").getPath());
            ...
            while (dir.hasMoreElements()) {
                ...
                if ("file".equals(protocol)) {
                    File file = new File(URLDecoder.decode(url.getPath().substring(1),"UTF-8"));
                    scan0(file);
